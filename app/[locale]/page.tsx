...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#0d1117] flex flex-col text-gray-300">
      {/* Navigation */}
      <header className="bg-[#161b22] border-b border-gray-700 py-4 px-6 sticky top-0 z-10">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="flex items-center gap-2 sm:gap-4">
            <Link
              href="/about"
              className="text-gray-400 hover:text-cyan-400 transition-colors text-sm hidden sm:inline"
            >
              About
            </Link>
            <Link
              href="/issues"
              className="bg-cyan-600 hover:bg-cyan-500 text-white font-semibold px-4 py-2 rounded-lg transition-colors text-sm"
            >
              Browse Issues
            </Link>
          </nav>
      ...
      <main className="flex-1">
        ...
        <section className="container mx-auto px-4 py-20 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-100 mb-6 leading-tight font-[family-name:var(--font-mono)]">
            Your Gateway to <span className="text-cyan-400">Open Source</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/issues"
              className="inline-flex items-center justify-center gap-2 bg-cyan-600 hover:bg-cyan-500 text-white font-semibold px-8 py-3 rounded-lg transition-colors text-lg"
            >
              Browse Issues
            ...
            <Link
              href="/about"
              className="inline-flex items-center justify-center gap-2 bg-transparent border border-gray-600 hover:border-cyan-500 text-gray-300 hover:text-cyan-400 font-semibold px-8 py-3 rounded-lg transition-colors text-lg"
            >
              Learn More
            </Link>
          </div>
          ...
          <div className="mt-16 flex flex-wrap justify-center gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm mt-1">Data Stored Server-Side</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-cyan-400">Open</p>
              <p className="text-gray-500 text-sm mt-1">Source Code</p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {FEATURES.map(feature => (
                <div
                  key={feature.title}
                  className="bg-[#161b22] border border-gray-700 rounded-xl p-6 hover:border-cyan-500/40 transition-colors"
                >
          ...
          <ol className="max-w-3xl mx-auto space-y-8">
            {STEPS.map(step => (
              <li key={step.number} className="flex gap-5">
                <div className="flex-shrink-0 w-10 h-10 bg-cyan-600 text-white rounded-full flex items-center justify-center font-bold text-sm">
                  {step.number}
                </div>
                <div>
        ...
        {/* Why Open Source */}
        <section className="bg-[#161b22] border-y border-gray-700 py-20">
        ...
        <section className="container mx-auto px-4 py-20 max-w-3xl">
          <div className="bg-[#161b22] border border-gray-700 rounded-xl p-8 text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-2">
              ...
              <Link
                href="/about"
                className="inline-flex items-center justify-center gap-2 text-cyan-400 hover:text-cyan-300 underline underline-offset-4 text-sm font-medium transition-colors"
              >
        ...
        <section className="container mx-auto px-4 pb-24">
          <div className="bg-[#161b22] border border-cyan-500/20 rounded-2xl p-12 text-center max-w-3xl mx-auto">
            ...
            <Link
              href="/issues"
              className="inline-flex items-center gap-2 bg-cyan-600 hover:bg-cyan-500 text-white font-semibold px-10 py-4 rounded-xl transition-colors text-lg"
            >
              Browse Issues Now
              <span aria-hidden="true">→</span>
            </Link>
